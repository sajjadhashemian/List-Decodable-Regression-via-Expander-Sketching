# expander-ldr Documentation

This package implements the **expander-sketched list-decodable regression** algorithm of Pourali–Hashemian–Ardeshir-Larijani (2025) in a modular, scikit-learn compatible way.

## Contents

- [Algorithm](algorithm.md) – description of the full pipeline and its components.
